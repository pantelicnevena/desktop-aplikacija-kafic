 ...
 * @author Nevena
 */
public class KreirajDistributera extends javax.swing.JFrame {

    /**
     * Creates new form KrairajDistributera
     */
    public KreirajDistributera() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Krairanje distributera");

        jLabel2.setText("Distributer ID:");

        jLabel3.setText("Naziv distributera:");
        ...
        buttonKreiraj.setText("Krairaj distributera");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(buttonVratiID, javax.swing.GroupLayout.DEFAULT_SIZE, 98, Short.MAX_VALUE))
    ...
    private void buttonVratiIDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonVratiIDActionPerformed
        try {
            TObjekat posalji = new TObjekat(null, "vratiDistributerID");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KreirajDistributera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KreirajDistributera().setVisible(true);
            }
        });
    }
