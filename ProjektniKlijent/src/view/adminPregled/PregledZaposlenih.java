...
import view.model.ModelTableZaposleni;

/**
 *
 * @author Nevena
 */
public class PregledZaposlenih extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pregled podataka o zaposlenima");
        ...
        buttonObrisi.setText("Obriši zaposlenog");
    ...
    private void buttonObrisiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonObrisiActionPerformed
        ...
        if (rb == -1) {
            ...
            try {
                ...
                String ime = (String) jTable1.getModel().getValueAt(rb, 1);
                String prezime = (String) jTable1.getModel().getValueAt(rb, 2);
                String korisnickoIme = (String) jTable1.getModel().getValueAt(rb, 3);
                String korisnickaSifra = (String) jTable1.getModel().getValueAt(rb, 4);
                
                Zaposleni zaposleni = new Zaposleni(id, ime, prezime, korisnickoIme, korisnickaSifra);
                TObjekat posalji = new TObjekat(zaposleni, "obrisiZaposlenog");
                KomunikacijaKlijent.vratiObjekat().posalji(posalji);
                TObjekat odgovor = KomunikacijaKlijent.vratiObjekat().procitaj();
                
                ModelTableZaposleni mtz = (ModelTableZaposleni) jTable1.getModel();
                mtz.obrisiRed(rb);
            } catch (IOException ex) {
                Logger.getLogger(PregledZaposlenih.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PregledZaposlenih.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PregledZaposlenih().setVisible(true);
            }
        });
    }
    ...
    public void popuniTabelu(){
        try {
            ...
            ModelTableZaposleni mtz = new ModelTableZaposleni(zaposleneOsobe);
